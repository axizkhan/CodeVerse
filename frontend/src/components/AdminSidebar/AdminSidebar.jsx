...
//           <ListItemIcon sx={{ color: '#FFF2DF' }}><Dashboard /></ListItemIcon>
//           {open && <ListItemText primary="Dashboard" />}
//         </ListItem>

//         <ListItem button onClick={() => setTutorialsOpen(!tutorialsOpen)}>
//           <ListItemIcon sx={{ color: '#FFF2DF' }}><MenuBook /></ListItemIcon>
//           {open && <ListItemText primary="Tutorial" />}
//           {open && (tutorialsOpen ? <ExpandLess /> : <ExpandMore />)}
//         </ListItem>

//         <Collapse in={tutorialsOpen} timeout="auto" unmountOnExit>
//           <List component="div" disablePadding sx={{ pl: open ? 4 : 2 }}>
//             <ListItem button component={Link} to="/admin/add-language">
//               <ListItemIcon sx={{ color: '#FFF2DF' }}><AddCircleOutline /></ListItemIcon>
//               {open && <ListItemText primary="Add Language" />}
//             </ListItem>
//             <ListItem button component={Link} to="/admin/add-chapter">
//               <ListItemIcon sx={{ color: '#FFF2DF' }}><AddCircleOutline /></ListItemIcon>
//               {open && <ListItemText primary="Add Chapter" />}
//             </ListItem>
//             <ListItem button component={Link} to="/admin/all-tutorials">
//               <ListItemIcon sx={{ color: '#FFF2DF' }}><ListAlt /></ListItemIcon>
//               {open && <ListItemText primary="All Tutorials" />}
//             </ListItem>
//           </List>
//         </Collapse>

//         <ListItem button component={Link} to="/admin/users">
//           <ListItemIcon sx={{ color: '#FFF2DF' }}><Person /></ListItemIcon>
//           {open && <ListItemText primary="Users" />}
//         </ListItem>

//         <ListItem button component={Link} to="/admin/membership">
//           <ListItemIcon sx={{ color: '#FFF2DF' }}><Group /></ListItemIcon>
//           {open && <ListItemText primary="Membership" />}
//         </ListItem>
//       </List>
